...
# 1. 오픈소스 소프트웨어
**오픈소스 소프트웨어** : 소스코드가 공개되어 <ins/>누구나 자유롭게 사용,복제,
수정, 배포할 수 있는 소프트웨어</ins>
...
10. 네트워크 관리 : `nmcli`, `ip`, `route`, `ping`, `traceroute`, `netstat`, `nmap`, `nfw`
# 3. Github
**GitHub** : 버전 관리 도구인 Git으로 관리되는 소스코드 형상관리 정보를
보여주는 웹 기반 서비스 ([link](https://github.com))
## 3.1. Github 활용법
### 3.2.1. 로컬 레포지토리에서 작업
